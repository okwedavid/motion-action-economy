...
///   Override at build time with `--dart-define=API_BASE_URL=...` (e.g. the
///   production Render build). When unset, local development uses the local
///   dev server by default. Android emulator reaches the host machine via
///   10.0.2.2.
class AppConfig {
  AppConfig._();
